...
stateTSIjitter <- ggplot(LAGOStrophic, aes(x = state, y = TSI.chl, fill = season)) +
...
write.csv(LAGOStrophic, file = "./Data/LAGOStrophic.csv", row.names = FALSE)
...
Other awesome functions: Ctr+Alt+I -> make a new code chunk
Tab to help file directories
